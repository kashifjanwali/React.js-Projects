...
function MyCv(props) {
  return (
    <div className="my-cv">
      ...
      <p id="my-profession">(Front-end React Developer)</p>

      <p class="adjust-cv" id="my-location">
        <ImLocation2 />House #12, Street#9, Pindora Near Benazir Chowk, Rawalpindi,
        Pakistan
      </p>
      ...
      <div>
        ...
        {/* <p className='social-networks'>
        <a href="https://arc.dev/@kashifjanwali"><AiOutlineRadarChart className="strong-icons arc"/></a>
      </p> */}
